...
namespace ImGui
{
	...
	IMGUI_API bool			Button(const char * label, const char * str_id, const ImVec2 & size_arg = ImVec2(0, 0));
	...
	IMGUI_API bool          ColorEdit4(const char* str_id, const char* label, float col[4], ImGuiColorEditFlags flags = 0);
