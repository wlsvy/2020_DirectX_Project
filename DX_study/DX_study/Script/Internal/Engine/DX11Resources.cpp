...
bool DX11Resources::Initialize(HWND hwnd, UINT width, UINT height)
{
	try {
		...
		CreateRenderTarget(m_RenderTargetViewArr[RenderTargetTypes::DeferredRenderTexture3].GetAddressOf(), m_RenderTargetSrvs[RenderTargetTypes::DeferredRenderTexture3].GetAddressOf(), m_RenderTargetUavs[RenderTargetTypes::DeferredRenderTexture3].GetAddressOf(), width, height);
